...
list1 = []
list2= ['pinchu','pallu','pop','manav','vishal']
...
#prints the list
mixed_datatype=['parshvi','20','5.2','single','Gandhinagar']
...
IT_COMPANIES [0]= 'Vishal'
print (IT_COMPANIES)

# 11 add IT Companies to the itcompanies 
IT_COMPANIES.append('APPIT')
print(IT_COMPANIES)

# 12 Insert an IT company in the middle of the companies list
IT_COMPANIES.insert(4,'MTECH')

# 13 Change one of the it_companies names to uppercase (IBM excluded!)
IT_COMPANIES[IT_COMPANIES.index('Vishal')] = IT_COMPANIES[IT_COMPANIES.index('Vishal')].upper()
print(IT_COMPANIES)
